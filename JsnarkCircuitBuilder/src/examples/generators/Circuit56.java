...
public class Circuit56 extends CircuitGenerator {

	private Wire[] inputs;

	public Circuit56(String circuitName) {
		super(circuitName);
	}
...
Wire x46 = x45.mul(inputs[4]);
        ...
        Wire result = d1.add(d2).add(d3).add(d4).add(d5).add(d6);
	...
	public static void main(String[] args) throws Exception {
        ...
        Circuit56 generator = new Circuit56("Circuit56");
