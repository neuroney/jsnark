...
public class Circuit517 extends CircuitGenerator {

	private Wire[] inputs;

	public Circuit517(String circuitName) {
		super(circuitName);
	}
...
Wire x417 = x416.mul(inputs[4]);
        ...
        Wire result = d1.add(d2).add(d3).add(d4).add(d5).add(d6).add(d7).add(d8).add(d9).add(d10).add(d11).add(d12).add(d13).add(d14).add(d15).add(d16).add(d17);
	...
	public static void main(String[] args) throws Exception {
        ...
        Circuit517 generator = new Circuit517("Circuit517");
