...
public class Circuit511 extends CircuitGenerator {

	private Wire[] inputs;

	public Circuit511(String circuitName) {
		super(circuitName);
	}
...
Wire x411 = x410.mul(inputs[4]);
        ...
        Wire result = d1.add(d2).add(d3).add(d4).add(d5).add(d6).add(d7).add(d8).add(d9).add(d10).add(d11);
	...
	public static void main(String[] args) throws Exception {
        ...
        Circuit511 generator = new Circuit511("Circuit511");
