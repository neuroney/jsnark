...
public class Circuit513 extends CircuitGenerator {

	private Wire[] inputs;

	public Circuit513(String circuitName) {
		super(circuitName);
	}
...
Wire x413 = x412.mul(inputs[4]);
        ...
        Wire result = d1.add(d2).add(d3).add(d4).add(d5).add(d6).add(d7).add(d8).add(d9).add(d10).add(d11).add(d12).add(d13);
	...
	public static void main(String[] args) throws Exception {
        ...
        Circuit513 generator = new Circuit513("Circuit513");
