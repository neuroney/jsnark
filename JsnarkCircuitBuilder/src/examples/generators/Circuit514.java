...
public class Circuit514 extends CircuitGenerator {

	private Wire[] inputs;

	public Circuit514(String circuitName) {
		super(circuitName);
	}
...
Wire x414 = x413.mul(inputs[4]);
        ...
        Wire result = d1.add(d2).add(d3).add(d4).add(d5).add(d6).add(d7).add(d8).add(d9).add(d10).add(d11).add(d12).add(d13).add(d14);
	...
	public static void main(String[] args) throws Exception {
        ...
        Circuit514 generator = new Circuit514("Circuit514");
