...
public class Circuit519 extends CircuitGenerator {

	private Wire[] inputs;

	public Circuit519(String circuitName) {
		super(circuitName);
	}
...
Wire x419 = x418.mul(inputs[4]);
        ...
        Wire result = d1.add(d2).add(d3).add(d4).add(d5).add(d6).add(d7).add(d8).add(d9).add(d10).add(d11).add(d12).add(d13).add(d14).add(d15).add(d16).add(d17).add(d18).add(d19);
	...
	public static void main(String[] args) throws Exception {
        ...
        Circuit519 generator = new Circuit519("Circuit519");
