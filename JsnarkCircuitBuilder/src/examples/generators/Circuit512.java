...
public class Circuit512 extends CircuitGenerator {

	private Wire[] inputs;

	public Circuit512(String circuitName) {
		super(circuitName);
	}
...
Wire x412 = x411.mul(inputs[4]);
        ...
        Wire result = d1.add(d2).add(d3).add(d4).add(d5).add(d6).add(d7).add(d8).add(d9).add(d10).add(d11).add(d12);
	...
	public static void main(String[] args) throws Exception {
        ...
        Circuit512 generator = new Circuit512("Circuit512");
