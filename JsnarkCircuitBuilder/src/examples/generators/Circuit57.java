...
public class Circuit57 extends CircuitGenerator {

	private Wire[] inputs;

	public Circuit57(String circuitName) {
		super(circuitName);
	}
...
Wire x47 = x46.mul(inputs[4]);
        ...
        Wire result = d1.add(d2).add(d3).add(d4).add(d5).add(d6).add(d7);
	...
	public static void main(String[] args) throws Exception {
        ...
        Circuit57 generator = new Circuit57("Circuit57");
